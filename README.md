...
The used snippets in this vault are from [janpstrunn/elegantvagrant](https://github.com/janpstrunn/elegantvagrant/tree/main/obsidian), which includes the `colorizer` and `elegantvagrant`
